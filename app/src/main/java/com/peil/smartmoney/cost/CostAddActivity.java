...
//      long temp = MoneyApplication.getDaoInstant().getCostItemDao().insertOrReplace(this.mCostItem);
...
//            .getCostItemTypeDao()
//            .queryBuilder()
//            .where(Properties.AmountTypeId.eq(item.get_id()))
//            .list();
...
//          .getCostItemDao()
//          .queryBuilder()
//          .where(com.peil.smartmoney.greendao.gen.CostItemDao.Properties._id.eq(intentItemId))
//          .unique();
...
//      this.updateChooseAccount(this.mAccountListData.indexOf(this.mCostItem.getCostAccount()));
...
//        "cost add datepicker ", " year = " + tempYear + " month = " + tempMonth + "day = " + tempDay
//    });
...
//    //((EditTextDialogBuilder) ((EditTextDialogBuilder) ((EditTextDialogBuilder) builder.setTitle(
//    //    "备注")).setPlaceholder("请输入备注...")
//    //    .setInputType(1)
//    //    .setDefaultText(
//    //        this.btn_remark.getText().toString().length() > 0 ? this.btn_remark.getText().toString()
//    //            : "")
//    //    .addAction("取消", new ActionListener() {
//    //      public void onClick(QMUIDialog dialog, int index) {
//    //        dialog.dismiss();
//    //      }
