 ...
 * 类别
 */
@Entity public class CostItemType implements Serializable {
    private static final long serialVersionUID = -3915607864422723131L;
    @Id(autoincrement = true) private Long _id;
    private String costTypeIcon;
    @NotNull @Unique private String costTypeName;
    private Long amountTypeId;
    @ToOne(joinProperty = "amountTypeId") private CostItemAmountType amountType;
    ...
    @Generated(hash = 956239630) public CostItemType() {
    }
    ...
    @Generated(hash = 789450003) private transient Long amountType__resolvedKey;
    
    /** To-one relationship, resolved on first access. */
    @Generated(hash = 880249269) public CostItemAmountType getAmountType() {
    ...
    @Generated(hash = 461477587) public void setAmountType(CostItemAmountType amountType) {
        synchronized (this) {
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 518208986) public void __setDaoSession(DaoSession daoSession) {
