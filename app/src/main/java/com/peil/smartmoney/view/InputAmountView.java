...
public class InputAmountView extends RelativeLayout {
    ...
    Button                        btn_1;
    Button                        btn_0, btn_2, btn_3, btn_4, btn_5, btn_6, btn_7, btn_8, btn_9, btn_dot, btn_del,
                                  btn_ok;
    TextView                      tv_amount;
    ...
    private void onAmountClicked(String amount) {
        ...
        // 只有一位，已经显示0，再次选0是无效的
        if (!tempAmount.isEmpty() && (tempAmount.length() == 1) && amount.equals("0") && tempAmount.equals("0")) {
            return;
        }
