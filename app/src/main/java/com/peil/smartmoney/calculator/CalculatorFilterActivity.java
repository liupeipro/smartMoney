...
//              显示备注
    ...
    private QMUIBottomSheet.BottomListSheetBuilder.OnSheetItemClickListener mAccountItemClickListener =
...
//      title
        ...
        if (intentItemId != -1) {
            ...
            int gridIndex = getAmountTypeList(mCostItem.getCostAmountType()).indexOf(mCostItem.getCostType());
...
//      4- 日期
    ...
    private void showChooseTimeView() {
        ...
        LogUtils.i("cost add datepicker ", " year = " + tempYear + " month = " + tempMonth + "day = " + tempDay);
    ...
    private void showInputRemarkView() {
        ...
        builder.setTitle("备注")
               ...
               .setDefaultText((btn_remark.getText().toString().length() > 0)
                               ? btn_remark.getText().toString()
                               : "")
               .addAction("取消",
                          ...
                          new QMUIDialogAction.ActionListener() {
                              ...
                              public void onClick(QMUIDialog dialog, int index) {
                                  ...
                                  if ((text != null) && (text.length() > 0)) {
                                      ...
                                      Toast.makeText(CalculatorFilterActivity.this, "请填入昵称", Toast.LENGTH_SHORT).show();
                                  }
                              }
                          })
